...
# 从CSV文件1中读取数据
df1 = pd.read_csv(r"C:\Users\zhijiel\Downloads\ERA5--1981-2020(vocation treated)\adaptor.mars,internal--1981-2020--daily\swvl4-percentile\1981-2020 raw\1981-location.csv")
...
# 将结果保存到一个新的CSV文件
df2.to_csv(r"C:\FIA-Data\FIA数据\USA southern 13 states after settling\P2-chapter2\2.5_COND\VA_COND+PLOT_selected_location.csv", index=False)
