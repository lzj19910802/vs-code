...
# 从CSV文件2中读取数据
df2 = pd.read_csv(r"C:\FIA-Data\FIA数据\USA southern 13 states after settling\P2-chapter2\2.5_COND\AR_COND+PLOT_selected.csv")
...
# 将结果保存到一个新的CSV文件
df2.to_csv(r"C:\FIA-Data\FIA数据\USA southern 13 states after settling\P2-chapter2\2.5_COND\AR_COND+PLOT_selected_location.csv", index=False)
