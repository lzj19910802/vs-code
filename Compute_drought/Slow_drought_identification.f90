module slowdrought_mod
   implicit none

contains

subroutine slowdrought(n,a,b,drt1, osev1, odur1, ospd1)
!======================================================================
! References:
...
real, dimension(n), intent(out) :: drt1
real, dimension(n), intent(out) :: osev1, odur1, ospd1
